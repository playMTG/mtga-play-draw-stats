...
vm.runInContext(source.slice(source.indexOf('let dailyRequest'),source.indexOf('function fillSelect')),context);
...
summary:{n:1,win_rate:{wr:100,n:1},play_rate:{wr:100,n:1},max_loss_streak:0,duration_sec:0,top_commanders:[],mulligan_known:0,deck_known:0,commander_known:0,commander_eligible:0}});
(async()=>{
